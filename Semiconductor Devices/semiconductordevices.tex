...
%  \maketitle 
  ...
  % ---------------------------------------------------------------------------
    ...
    \begin{center}
       \begin{align*}
       & \text{Conductivity}: \sigma \left[S/m\right] \\
       & \text{Resistivity}: \rho=\sigma^{-1} \left[\Omega\cdot m\right]\\
       & \text{Resistance}: R=\rho\frac{l}{A}=\rho\frac{l}{r^2\pi} \left[\Omega\right]
        \end{align*} 
    \end{center}
